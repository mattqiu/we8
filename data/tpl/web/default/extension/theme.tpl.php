						...
						if (themes[n].site_branch != null) {
							...
							for (var index in branches) {
								if ( (parseInt(branches[index].displayorder) > site_branch_sort)
									...
									var tips = '来自无妄云服务更新';
									$(this).html('<div class="img-rounded update-bg"></div><div class="update-div"><a href="javascript:;" class="btn-danger img-circle update-btn" title="来自无妄云服务更新" onclick=\'setThemeInfo("' + n + '", "' + v +'");\' );>更新</a></div>');
									break;
								}
							}
						}
