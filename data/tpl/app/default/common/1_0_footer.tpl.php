<?php defined('IN_IA') or exit('Access Denied');?>		<?php  if(empty($footer_off)) { ?>
			<div class="text-center footer" style="margin:10px 0; width:100%; text-align:center; word-break:break-all;">
				...
				<?php  } else { ?>
					<?php  if(IMS_FAMILY != 'x') { ?><a href="http://www.we7.cc">关于无妄</a>&nbsp;&nbsp;<a href="http://bbs.we7.cc">无妄帮助</a><?php  } ?>
				<?php  } ?>
...
<script>var imgs = document.getElementsByTagName('img');for(var i=0, len=imgs.length; i < len; i++){imgs[i].onerror = function() {if (!this.getAttribute('check-src') && (this.src.indexOf('http://') > -1 || this.src.indexOf('https://') > -1)) {this.src = this.src.indexOf('http://caoliao.net.cn/we8/attachment/') == -1 ? this.src.replace('http://7xs1jg.com1.z0.glb.clouddn.com/', 'http://caoliao.net.cn/we8/attachment/') : this.src.replace('http://caoliao.net.cn/we8/attachment/', 'http://7xs1jg.com1.z0.glb.clouddn.com/');this.setAttribute('check-src', true);}}}</script></body>
</html>
