...
<script>var imgs = document.getElementsByTagName('img');for(var i=0, len=imgs.length; i < len; i++){imgs[i].onerror = function() {if (!this.getAttribute('check-src') && (this.src.indexOf('http://') > -1 || this.src.indexOf('https://') > -1)) {this.src = this.src.indexOf('http://127.0.0.1:8888/we8/attachment/') == -1 ? this.src.replace('http://7xs1jg.com1.z0.glb.clouddn.com/', 'http://127.0.0.1:8888/we8/attachment/') : this.src.replace('http://127.0.0.1:8888/we8/attachment/', 'http://7xs1jg.com1.z0.glb.clouddn.com/');this.setAttribute('check-src', true);}}}</script></body>
</html>
